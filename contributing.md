...
- El proyecto debe **dar soporte específico a Galicia** o incluir funcionalidades relevantes para usuarios en esta comunidad autónoma.
...
5. **Incluye en la descripción de la PR la URL del servicio, API o institución gallega** a la que el software da soporte (p.ej. xunta.gal, usc.es, uvigo.es). Esto ayuda a verificar que el proyecto es relevante para Galicia.
