...
Un repositorio se incluye porque interactúa con instituciones, servicios, infraestructura, normativas o datos propios de Galicia. No basta con que el autor sea de Galicia o resida aquí. Un framework genérico creado por un developer de Galicia no pertenece a esta lista. Un cliente para una API de servicios de Galicia sí.
