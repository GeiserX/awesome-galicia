...
El criterio fundamental es: **se acepta software que da soporte específico a Galicia, no software hecho por alguien de Galicia.**

Un repositorio se incluye porque interactúa con instituciones, servicios, infraestructura, normativas o datos propios de Galicia. No basta con que el autor resida o trabaje aquí. Un framework genérico creado por un developer de Galicia no pertenece a esta lista. Un cliente para la API de datos abiertos del gobierno de Galicia o una integración con servicios públicos de Galicia sí.

- **Sí:** Clientes de APIs de instituciones de Galicia, integraciones con servicios públicos regionales, scrapers de transporte o datos abiertos de Galicia.
- **No:** Librerías genéricas creadas por equipos de Galicia, software genérico cuyo autor simplemente reside en la comunidad.

Ver `AGENTS.md` (si existe) para criterios detallados adicionales.

## Revisar PRs

1. Comprobar que el proyecto **da soporte específico a Galicia** (no simplemente que el autor es de Galicia).
2. Verificar que la PR incluye la **URL del servicio o institución de Galicia** que el proyecto soporta.
...
4. Si el propietario del proyecto no ha sido notificado, abrir un issue de cortesía en su repo:
   - Título: `Incluido en awesome-galicia`
...
| No cumple criterios de inclusión | Eliminados por no ser específicos de Galicia |
