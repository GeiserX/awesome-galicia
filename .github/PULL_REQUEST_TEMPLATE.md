...
- URL del repositorio
- URL del servicio/API/institución gallega a la que da soporte (p.ej. xunta.gal, usc.es, uvigo.es)
Elimina esta sección si no aplica.
-->

| Proyecto | Servicio/Institución gallega |
|----------|-------------------------------|
...
- URL del repositorio
- Motivo (archivado, no funcional, reemplazado, no específico de Galicia, etc.)
Elimina esta sección si no aplica.
-->
